...
def listener(a,b):
  while True:
                messageFrom = subscribe.simple(person_to + "/" + person_from, hostname="broker.shiftr.io",auth={'password':'aroraarora',
                                                                                                                        'username':'nishinishi'})
...
while True:
  ...
  publish.single(person_from + "/" + person_to,messageTo, hostname="broker.shiftr.io",
                       auth = {'username':"nishinishi", 'password':"aroraarora"})
